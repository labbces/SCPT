...
#naming output
out = "Exclusive_classification_panTranscriptomeClassificationTable_I1.tsv"
...
interesting_genes <- factor(as.integer(interesting_table$classification == "Exclusive"))
...
ggplot(ggdata,
  ...
  coord_flip()
ggplot2::ggsave("Exclusive_GOTerms_P30_Cortex_Fisher.pdf",
                device = NULL,
                height = 8.5,
                width = 12)
