...
#naming output
out = "Soft-core_classification_panTranscriptomeClassificationTable_I1.tsv"
...
interesting_genes <- factor(as.integer(interesting_table$classification == "Soft-core"))
...
ggplot(ggdata,
  ...
  coord_flip()
ggplot2::ggsave("Soft-core_GOTerms_P30_Cortex_Fisher.pdf",
                device = NULL,
                height = 8.5,
                width = 12)
