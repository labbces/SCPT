...
output_file = "Pan-Transcriptome_Size." + os.path.basename(input_file)
output_pan = "Pan-Transcriptome_Size." + os.path.basename(input_file)
output_core = "Core-Transcriptome_Size." + os.path.basename(input_file)
output_accessory = "Accessory-Transcriptome_Size." + os.path.basename(input_file)
output_exclusive = "Exclusive-Transcriptome_Size." + os.path.basename(input_file)
...
#                print(f'{n_sample} {orthogroup}')  
                ...
                if number_of_genotypes_in_orthogroups > 1 and proporcao < 0.9:
